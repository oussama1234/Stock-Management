    ...
    'schemas' => [
        'default' => [
            ...
            'types' => [
                ...
                'Product' => App\GraphQL\Types\Product::class,
                'Category' => App\GraphQL\Types\Category::class,
                'Sale' => App\GraphQL\Types\Sale::class,
                'SaleItem' => App\GraphQL\Types\SaleItem::class,
                'Purchase' => App\GraphQL\Types\Purchase::class,
                'PurchaseItem' => App\GraphQL\Types\PurchaseItem::class,
                'StockMovement' => App\GraphQL\Types\StockMovement::class,
                'SourceUnion' => App\GraphQL\Unions\SourceUnion::class,
