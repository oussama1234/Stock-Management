// src/pages/Inventory/components/charts/StockDistributionChart.jsx
// Pie chart for stock distribution
import React, { memo } from 'react';
import { PieChart, Pie, Cell, ResponsiveContainer, Tooltip, Legend } from 'recharts';

const StockDistributionChart = memo(function StockDistributionChart({ data = [] }) {
      ...
      return (
        <div className="bg-white dark:bg-gray-800 p-3 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Units: <span className="font-medium">{new Intl.NumberFormat().format(data.value)}</span>
          </p>
        </div>
      );
    }
