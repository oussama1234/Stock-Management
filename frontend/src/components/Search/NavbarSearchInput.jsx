// src/components/Search/NavbarSearchInput.jsx
// Lightweight search input component specifically designed for navbar use
import React, { forwardRef, memo, useCallback, useEffect, useImperativeHandle, useRef } from 'react'
import { Search as SearchIcon, X } from 'lucide-react'

// Navbar-specific search input with minimal dependencies
const NavbarSearchInput = memo(forwardRef(function NavbarSearchInput({
  value,
  onChange,
  onSubmit,
  onEscape,
