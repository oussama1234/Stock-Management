...
import { Eye, EyeOff, LogIn, Brain, BarChart3, Database, Shield, ExclamationCircle } from 'lucide-react';
          ...
          <div className="px-8 py-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                // Display error message if login fails with good styling and background and icon 
                {error && (
                  <div className="mt-4 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
                    <div className="flex items-center">
                      <ExclamationCircle className="h-5 w-5 text-red-500 mr-2" />
