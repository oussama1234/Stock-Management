...
import { Eye, EyeOff, LogIn, Brain, BarChart3, Database, Shield, AlertCircle } from 'lucide-react';
...
const Login = () => {
  ...
  const {loading, handleLogin} = useAuth(); // Using the custom hook to access auth context
  ...
  const handleSubmit = async (e) => {
    ...
    if (response && response.user) {
      ...
      setError(response.response.data.message || "Login failed. Please try again.");
    }
  };
