...
const MyProfile = () => {
  ...
  const validateForm = () => {
    ...
    if (userData.currentPassword || userData.newPassword || userData.newPassword_confirmation) {
      ...
      if (userData.newPassword !== userData.newPassword_confirmation) {
        newErrors.newPassword_confirmation = 'Passwords do not match';
      }
    }
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={userData.newPassword_confirmation}
                    onChange={handleInputChange}
                    className={`pl-10 pr-12 py-3 w-full rounded-xl border focus:ring-2 focus:outline-none transition-all duration-300 ${
                ...
                <AnimatePresence>
                  {errors.newPassword_confirmation && (
                    <motion.p 
                      ...
                      className="text-red-500 text-sm mt-1 flex items-center"
                    >
                      <XCircle className="h-4 w-4 mr-1" /> {errors.newPassword_confirmation}
                    </motion.p>
                  )}
                </AnimatePresence>
              </div>
