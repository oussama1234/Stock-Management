  ...
  try {
    ...
    const updateProfile = async (userData, file) => {
        ...
        try
        {
            ...
            data.status === 400 ? Toast.error(data.message) : Toast.success(data.message);
        ...
        catch(error)
        {
            ...
            const passError = error.response?.data?.status === 400 ? error.response?.data?.message : "Failed to update Profile, please try again"
