        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-indigo-700/50">
            ...
            >
              ...
              <p className="text-blue-200 text-xs mb-3">Get access to all features</p>
              <button className="w-full py-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-lg text-sm font-medium hover:from-blue-400 hover:to-indigo-400 transition-all duration-300 shadow-md">
                Upgrade Now
              </button>
            </motion.div>
          </div>
