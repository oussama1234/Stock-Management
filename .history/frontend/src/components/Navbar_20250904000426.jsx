...
import { Bell, Search, Menu, X, BarChart3, Settings, LogOut, User, HelpCircle, BarChart3  } from 'lucide-react';

const Navbar = ({ toggleSidebar, isSidebarOpen }) => {
  const [isProfileOpen, setIsProfileOpen] = useState(false);
  const [notifications, setNotifications] = useState([
    { id: 1, text: 'Low stock alert for Product A', time: '10 mins ago' },
    { id: 2, text: 'New sale recorded', time: '30 mins ago' },
    { id: 3, text: 'Inventory update completed', time: '1 hour ago' }
  ]);
                ...
                {isProfileOpen && (
                  ...
                  >
                    <div className="px-4 py-3 border-b border-white/10">
                      ...
                      <p className="text-sm text-blue-300">admin@stockai.com</p>
                    </div>
